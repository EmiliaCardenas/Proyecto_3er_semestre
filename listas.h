...
/*
toStringLines - función de una lista que sea separada por líneas

Recorre cada nodo de la lista enlazada
y va por el valor de cada nodo y hace un salto de línea.

@param 
@return std::string debe ser: una cadena que contiene los valores 
de la lista con salto de linea.
*/
template <class T>
std::string List<T>::toStringLines() {
    Link<T>* current = head; 
    std::string result;
